...
def _make_strategy_with_min_max_for_type(
    ...
    if a_type == int:
        ...
        strategy = hypothesis.strategies.integers(min_value=min_value, max_value=max_value)
        ...
        strategy = hypothesis.strategies.dates(
            min_value=inferred.min_value if inferred.min_value is not None else datetime.date.min,
            max_value=inferred.max_value if inferred.max_value is not None else datetime.date.max)
        ...
        strategy = hypothesis.strategies.timedeltas(
            min_value=inferred.min_value if inferred.min_value is not None else datetime.timedelta.min,
            max_value=inferred.max_value if inferred.max_value is not None else datetime.timedelta.max)
